...
export type WhereOp = "=" | "!=" | "<" | "<=" | ">" | ">=" | "LIKE" | "IN" | "BETWEEN" | "IS_NULL" | "IS_NOT_NULL";
...
export type OrderByRef = ColumnRef | {
    type: "position";
    index: number;
};
...
export type ParsedQuery = WithQuery | SelectQuery | SetQuery | CreateTableQuery | DropTableQuery | AlterTableQuery | ShowTablesQuery | DescribeTableQuery | CreateTriggerQuery | DropTriggerQuery | InsertQuery | UpdateQuery | DeleteQuery;
